...
public:
	...
	void Fire(FTransform BulletSpawnTransform, UParticleSystem* MuzzleFlash, USceneComponent* AttachTo, int32 PlayerControlerID = -1, AActor* ControllerRef = nullptr, APawn* NewInstigator = nullptr);
